...
@NamedQueries({ @NamedQuery(name = "ListeNamed", query = "SELECT e FROM Employe AS e"),
		@NamedQuery(name = "oneNamed", query = "SELECT e FROM Employe AS e WHERE e.nom=:pNom AND e.prenom=:pPrenom") })
