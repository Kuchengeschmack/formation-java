...
<body>
	...
	<form class="form-horizontal" method="post" action="send">
		...
		<div class="form-group">
			<label for="idId" class="col-sm-2 control-label">Id du client
				créditeur: </label>
			<div class="col-sm-10">
				<input type="number" class="form-control" id="idIdClientCrediteur"
					placeholder="IdClientCrediteur" name="pIdClientCrediteur" required>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				<button type="submit" class="btn btn-success" name="pTypeCompte"
					value="<%=request.getParameter("pTypeCompte")%>">Virer</button>
			</div>
		</div>
	</form>
